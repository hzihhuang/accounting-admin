...
var Gi = (i, n, e) =>
    n in i
      ? Oe(i, n, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (i[n] = e),
  ui = (i, n) => {
    for (var e in n || (n = {})) We.call(n, e) && Gi(i, e, n[e]);
    if (Xi) for (var e of Xi(n)) Ze.call(n, e) && Gi(i, e, n[e]);
    return i;
  },
  wi = (i, n) => Ne(i, Fe(n));
var oi = (i, n, e) =>
  new Promise((g, u) => {
    var h = o => {
      ...
      s = o => (o.done ? g(o.value) : Promise.resolve(o.value).then(h, t));
    s((e = e.apply(i, n)).next());
  });
import {
  s as Ue,
  v as Ke,
...
import {
  ...
  c as yh,
  f as fh
} from "./dark-D1G2S-EN.js";
import { u as Mi } from "./epTheme-C-t4O6JT.js";
import { u as Mn } from "./hooks-avKaykaq.js";
import { S as zh } from "./sortable.esm-7jaD_3Ar.js";
import { R as ki } from "./index-BrokqKHn.js";
...
const mh =
  ...
  bh = [
    ["ep/home-filled", mh],
    ["ri/search-line", ph],
    ["ri/information-line", xh]
  ];
bh.forEach(([i, n]) => {
  Ue(i, Ke(n));
});
const jh = Ye("pure-setting", {
  state: () => ({
    title: Xn().Title,
    fixedHeader: Xn().FixedHeader,
    hiddenSideBar: Xn().HiddenSideBar
  }),
  getters: {
    getTitle(i) {
      return i.title;
...
const wh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function vh(i, n) {
  return (
    d(),
    z(
      ...
      n[0] ||
        (n[0] = [
          f("path", { fill: "currentColor", d: "M5 11v2h14v-2z" }, null, -1)
        ])
    )
  );
}
const qh = G({ name: "ri-subtract-line", render: vh }),
  kh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function _h(i, n) {
  return (
    d(),
    z(
...
const Ch = G({ name: "ri-text-spacing", render: _h }),
  Sh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Ih(i, n) {
  return (
    d(),
    z(
...
const Th = G({ name: "ri-text-direction-l", render: Ih }),
  $h = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Mh(i, n) {
  return (
    d(),
    z(
...
const Lh = G({ name: "ri-text-direction-r", render: Mh }),
  Ah = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Ph(i, n) {
  return (
    d(),
    z(
...
const Dh = G({ name: "ep-refresh-right", render: Ph }),
  Vh = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Rh(i, n) {
  return (
    d(),
    z(
...
const zi = G({ name: "ep-close", render: Rh });
function $e() {
  var pn, wn;
  const i = Ei(),
    n = Ri(),
    ...
    c = M(!1),
    r = M(
      ((pn = An().getItem(`${ii()}configure`)) == null
        ? void 0
        : pn.showModel) || "smart"
    ),
    y =
      (wn = M(An().getItem(`${ii()}configure`).hideTabs)) != null
        ? wn
        : M("false"),
    j = I(() => Ln().multiTags),
    p = Di([
      { icon: Dh, text: "重新加载", divided: !1, disabled: !1, show: !0 },
      {
        icon: zi,
        text: "关闭当前标签页",
        divided: !1,
      ...
      { icon: ke, text: "内容区全屏", divided: !0, disabled: !1, show: !0 }
    ]);
  function b(V, un, rn) {
    var Dn, cn;
    return Qi(
      (Dn = i == null ? void 0 : i.meta) == null ? void 0 : Dn.showLink
    ) &&
  ...
  const x = I(() => V => {
      var un, rn;
      return (
        Qi((un = V == null ? void 0 : V.meta) == null ? void 0 : un.fixedTag) &&
        ((rn = V == null ? void 0 : V.meta) == null ? void 0 : rn.fixedTag) ===
          !0
      );
    }),
    D = I(() => (V, un) => {
      if (un !== 0) return b(V, !0, !1);
    }),
    A = I(() => V => b(V, "is-active", "")),
    B = I(() => V => b(V, "schedule-active", "")),
    U = I(() => ({
      transform: `translateX(${t.value}px)`,
      transition: c.value ? "none" : "transform 0.5s ease-in-out"
    })),
    K = I(() => ({ left: h.value + "px", top: u.value + "px" })),
    q = () => {
      s.value = !1;
    };
  function O(V) {
    if ((V && (o.value = V), l(r) === "smart")) {
      if (di(e.refs["schedule" + V][0], "schedule-active")) return;
      (Nn(!0, "schedule-in", e.refs["schedule" + V][0]),
        Nn(!1, "schedule-out", e.refs["schedule" + V][0]));
    } else {
      if (di(e.refs["dynamic" + V][0], "is-active")) return;
      (Nn(!0, "card-in", e.refs["dynamic" + V][0]),
        Nn(!1, "card-out", e.refs["dynamic" + V][0]));
    }
  }
  function Q(V) {
    if (((o.value = -1), l(r) === "smart")) {
      if (di(e.refs["schedule" + V][0], "schedule-active")) return;
      (Nn(!1, "schedule-in", e.refs["schedule" + V][0]),
        Nn(!0, "schedule-out", e.refs["schedule" + V][0]));
    } else {
      if (di(e.refs["dynamic" + V][0], "is-active")) return;
      (Nn(!1, "card-in", e.refs["dynamic" + V][0]),
        Nn(!0, "card-out", e.refs["dynamic" + V][0]));
    }
  }
  function mn() {
    g.hiddenSideBar
  ...
  return (
    Pn(() => {
      if (!r.value) {
        const V = An().getItem(`${ii()}configure`);
        ((V.showModel = "card"), An().setItem(`${ii()}configure`, V));
      }
    }),
    {
      Close: zi,
...
const Oh = gn(Eh, [["render", Hh]]),
  Nh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Fh(i, n) {
  return (
    d(),
    z(
...
const Wh = G({ name: "ri-arrow-down-s-line", render: Fh }),
  Zh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Uh(i, n) {
  return (
    d(),
    z(
...
const Kh = G({ name: "ri-arrow-right-s-line", render: Uh }),
  Yh = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Xh(i, n) {
  return (
    d(),
    z(
...
const Gh = G({ name: "ri-arrow-left-s-line", render: Xh }),
  Qh = { class: "arrow-left" },
  Jh = ["onContextmenu", "onMouseenter", "onMouseleave", "onClick"],
  nt = {
    class: "tag-title dark:text-text_color_primary! dark:hover:text-primary!"
  },
  it = ["onClick"],
  et = { key: 1, class: "chrome-tab" },
  ht = { class: "chrome-tab__bg" },
  tt = { class: "tag-title" },
  gt = ["onClick"],
  ut = { class: "arrow-right" },
  ot = ["onClick"],
  st = { class: "arrow-down" },
  lt = Z({
    __name: "index",
    setup(i) {
      ...
      const {
        ...
        Dn = M(),
        cn = M(!1),
        Kn = (W = Si()) == null ? void 0 : W.path,
        Bn = [
          ...Qe,
          ...bn().flatteningRoutes.filter(v => {
            var S;
            return (S = v == null ? void 0 : v.meta) == null
              ? void 0
              : S.fixedTag;
          })
        ],
        Cn = () =>
          oi(null, null, function* () {
            yield Wn();
            const v = s.value.findIndex(S =>
              Qn(e.query)
                ? Qn(e.params)
                  ? e.path === S.path
                  : Gn(e.params, S.params)
                : Gn(e.query, S.query)
            );
            Yn(v);
          }),
        Yn = v =>
          oi(null, null, function* () {
            ...
            const $ = t.refs["dynamic" + v][0],
              N = $ == null ? void 0 : $.offsetLeft,
              hn = $ == null ? void 0 : $.offsetWidth,
              E = rn.value
                ? (Y = rn.value) == null
                  ? void 0
                  : Y.offsetWidth
              ...
              H = V.value
                ? (an = V.value) == null
                  ...
                  : an.offsetWidth
                : 0;
            (E <= H ? (cn.value = !0) : (cn.value = !1),
              H < E || N === 0
                ? (y.value = 0)
                : N < -y.value
                  ? (y.value = -N + S)
                  : N > -y.value && N + hn < -y.value + E
                    ? (y.value = Math.min(0, E - hn - N - S))
                    : (y.value = -(N - (E - S - hn))));
          }),
        Sn = v => {
          var N;
          const S = rn.value
              ? (N = rn.value) == null
                ...
                : N.offsetWidth
              : 0,
            $ = V.value ? V.value.offsetWidth : 0;
          (v > 0
            ? (y.value = Math.min(0, y.value + v))
            : S < $
              ? y.value >= -($ - S) && (y.value = Math.max(y.value + v, S - $))
              : (y.value = 0),
            (D.value = !1));
        },
        Jn = v => {
          D.value = !0;
          const S = Math.abs(v.deltaX) + Math.abs(v.deltaY);
          let $ = 0;
          (v.deltaX < 0 ? ($ = S > 0 ? S : 100) : ($ = S > 0 ? -S : -100),
            C($));
        },
        C = v => {
          let $ = Math.abs(v);
          const N = () => {
            const hn = Math.sign(v) * Math.min(20, $);
            (Sn(hn), ($ -= Math.abs(hn)), $ > 0 && requestAnimationFrame(N));
          };
          requestAnimationFrame(N);
        };
      function T(v) {
        const S = s.value.some(N => N.path === v);
        function $(N, hn) {
          S ||
            N.forEach(E => {
              E.path === hn
                ...
                : E.children && E.children.length > 0 && $(E.children, hn);
            });
        }
        $(g.options.routes, v);
      }
      function R() {
        const { fullPath: v, query: S } = l(e);
        (g.replace({ path: "/redirect" + v, query: S }), vi(e, "refresh"));
      }
      function en(v, S, $) {
        var H, Y, an, gi;
        const N = s.value.findIndex(xn => {
            if (xn.query) {
              if (xn.path === v.path) return xn.query === v.query;
            } else if (xn.params) {
              if (xn.path === v.path) return xn.params === v.params;
            } else return xn.path === v.path;
          }),
          hn = (xn, yn, ai) => {
            (ai
              ? Ln().handleTags("equal", [Bn, v].flat())
              : Ln().handleTags("splice", "", { startIndex: xn, length: yn }),
              Cn());
          };
        $ === "other"
          ? hn(1, 1, !0)
          : $ === "left"
            ? hn(Bn.length, N - Bn.length)
            : $ === "right"
              ? hn(N + 1, s.value.length)
              : hn(N, 1);
        const E = Ln().handleTags("slice");
        if (S === e.path) {
          if ($ === "left") return;
          (H = E[0]) != null && H.query
            ? g.push({ name: E[0].name, query: E[0].query })
            : (Y = E[0]) != null && Y.params
              ? g.push({ name: E[0].name, params: E[0].params })
              : g.push({ path: E[0].path });
        } else {
          if (!s.value.length || s.value.some(xn => xn.path === e.path)) return;
          (an = E[0]) != null && an.query
            ? g.push({ name: E[0].name, query: E[0].query })
            : (gi = E[0]) != null && gi.params
              ? g.push({ name: E[0].name, params: E[0].params })
              : g.push({ path: E[0].path });
        }
      }
      ...
      function L(v, S, $) {
        ...
        switch (
          ...
          case 4:
            ...
            break;
          case 5:
            (Ln().handleTags("splice", "", {
              startIndex: Bn.length,
          ...
          case 6:
            (wn(),
              setTimeout(() => {
                p.hiddenSideBar
                  ? ((o[6].icon = Je), (o[6].text = "内容区退出全屏"))
                  : ((o[6].icon = ke), (o[6].text = "内容区全屏"));
              }, 100));
            break;
        }
        setTimeout(() => {
      ...
      function dn(v, S = {}, $ = !1) {
        ...
        let E = -1;
        Qn(S)
          ? (E = N.findIndex(yn => yn.path === v))
          : (E = N.findIndex(yn => Gn(yn.query, S)));
        function H() {
          var yn, ai;
          (ai = (yn = N[E]) == null ? void 0 : yn.meta) != null &&
            ai.fixedTag &&
            Array.of(1, 2, 3, 4, 5).forEach(He => {
              o[He].disabled = !0;
            });
        }
        (Hn(!0),
            ...
            : E === 1 && hn === 2
              ...
              : hn - 1 === E && E !== 0
                ? ((o[3].show = !1),
                  ...
                  (o[3].disabled = !0),
                  (an = (Y = N[E - 1]) == null ? void 0 : Y.meta) != null &&
                    an.fixedTag &&
                    ((o[2].show = !1), (o[2].disabled = !0)),
                  H())
                : E === 0 || v === `/redirect${Kn}`
                  ? On(!0)
                  : (On(
                      !1,
                      (xn = (gi = N[E - 1]) == null ? void 0 : gi.meta) == null
                        ? void 0
                        : xn.fixedTag
                    ),
                    H()));
      ...
      function ti(v, S) {
        ...
        (O(),
          v.path === Kn ||
          ((Y = v == null ? void 0 : v.meta) != null && Y.fixedTag)
            ? (Hn(!1), (o[0].show = !0))
            : e.path !== v.path && e.name !== v.name
              ? ((o[0].show = !1), dn(v.path, v.query))
              : s.value.length === 2 && e.path !== v.path
                ? (Hn(!0), (o[4].show = !1))
                : e.path === v.path && dn(v.path, v.query, !0),
          (U.value = v));
        const $ = 140,
          N = l(un).getBoundingClientRect().left,
          E = l(un).offsetWidth - $,
          H = S.clientX - N + 5;
        (H > E ? (c.value = E) : (c.value = H),
          Fi().hiddenSideBar
            ? (a.value = S.clientY)
            : (a.value = S.clientY - 40),
          Wn(() => {
            u.value = !0;
          }));
      }
      function ji(v) {
        ...
        (S
          ? v.query
            ? g.push({ name: S, query: v.query })
            : v.params
              ? g.push({ name: S, params: v.params })
              : g.push({ name: S })
          : g.push({ path: $ }),
          fn.emit("tagOnClick", v));
      }
      return (
        _e(Dn, O, { detectIframe: !0 }),
        $n(e, () => {
          ((b.value = -1), Cn());
        }),
        Q(() => {
        ...
        (v, S) => {
          const $ = k("IconifyIconOffline"),
            N = k("el-dropdown-item"),
            hn = k("el-dropdown-menu"),
            E = k("el-dropdown");
          return l(h)
            ? F("", !0)
            : (d(),
                ...
                [
                  ...
                  f(
                    "div",
                    {
                      ...
                      class: J([
                        "scroll-container",
                        l(r) === "chrome" && "chrome-scroll-container"
                      ]),
                      onWheel: _n(Jn, ["prevent"])
                    },
                    [
                      f(
                        "div",
                    ...
                    { trigger: "click", placement: "bottom-end", onCommand: w },
                    {
                              ...
                              zn(
                                ...
                                (H, Y) => (
                                  ...
                                  P(
                                    ...
                                    {
                                      key: Y,
                                      command: { key: Y, item: H },
                                      divided: H.divided,
                                      disabled: H.disabled
                                    },
                                    {
                                      default: _(() => [
                                        m($, { icon: H.icon }, null, 8, [
                                          "icon"
                                        ]),
                                        jn(" " + nn(H.text), 1)
                                      ]),
                      ...
                      default: _(() => [
                        f("span", st, [
                          m(
                            $,
                            { icon: l(Wh), class: "dark:text-white" },
                            null,
                            8,
                            ["icon"]
                          )
  ...
  rt = gn(lt, [["__scopeId", "data-v-37ca5e55"]]);
function ct(i = !1) {
  const n = M(i);
  function e(t) {
    n.value = t;
...
const qn = { Normal: 1, Surname: 10, Custom: 100 };
function In(i) {
  var n;
  return (
    i.length -
    (((n = i.match(yt)) === null || n === void 0 ? void 0 : n.length) || 0)
  );
}
function hi(i) {
  const n = [];
...
const ft = [
  ...
  he = { 重: "chóng", 行: "háng", 斗: "dǒu", 更: "gēng" };
function bt() {
  const i = {
    零一: "líng yī",
    〇一: "líng yī",
...
const te = bt(),
  ...
  vt = Object.keys(Le);
function qt(i, n, e) {
  if (vt.indexOf(i) === -1) return li(i);
  if (n === e && n && li(n) !== n) return xi(li(i));
  if (e && !wt[i].includes(e)) {
    const g = li(e);
    if (g !== e) {
      const u = bi(g),
        h = Le[i];
...
function kt(i, n) {
  if (i === "了" && (!n || !Un.get(n))) return "liǎo";
}
function _t(i, n) {
  if (i === "々") return !n || !Un.get(n) ? "tóng" : Un.get(n).split(" ")[0];
}
function ge(i, n, e) {
  return _t(i, n) || kt(i, n) || qt(i, n, e) || li(i);
}
const Li = {
    南宫: "nán gōng",
    第五: "dì wǔ",
...
function Mt(i) {
  return i.priority === qn.Custom
    ? -(i.length * i.length * 100)
    : i.priority === qn.Surname
    ...
    for (; u && u.index + u.length - 1 === h; ) {
      const o = u.index,
        a = {
          ...
          decimal: t.decimal + Mt(u),
          patterns: t.patterns,
          concatPattern: u
        };
      (ce(a), (e[o] = re(e[o], a)), (u = i[--g]));
    }
    const s = {
...
function Pt(i, n) {
  ...
  for (let h = n - 1; h >= 0; h--) {
    ...
    for (; u && u.index + u.length - 1 === h; ) {
      const o = u.index,
        a = { count: At(u) + t.count, patterns: t.patterns, concatPattern: u };
      ((e[o] = ae(e[o], a)), (u = i[--g]));
    }
    const s = { count: 1 + t.count, patterns: t.patterns };
    ((e[h] = ae(e[h], s)),
      e[h].concatPattern &&
        ((e[h].patterns = e[h].patterns.concat(e[h].concatPattern)),
        (e[h].concatPattern = void 0),
...
class Rt {
  ...
  buildTrie(n) {
    for (let e of n) {
      ...
      for (let h = 0; h < g.length; h++) {
        let t = g[h];
        if (!u.children.has(t)) {
          const s = new ye(u, g.slice(0, h).join(""), t);
          (u.children.set(t, s), this.addNodeToQueues(s));
        }
        u = u.children.get(t);
      }
  ...
  addNodeToQueues(n) {
    (this.queues[In(n.prefix)] || (this.queues[In(n.prefix)] = []),
      this.queues[In(n.prefix)].push(n));
  }
  insertPattern(n, e) {
  ...
  match(n, e) {
    ...
    for (let t = 0; t < h.length; t++) {
      let s = h[t];
      for (; g !== null && !g.children.has(s); ) g = g.fail;
      if (g === null) g = this.root;
      else {
        g = g.children.get(s);
        const o = g.patterns.find(c =>
          e === "off"
            ? c.priority !== qn.Surname
            : e === "head"
              ? c.length - 1 - t === 0
              : !0
        );
        o &&
          u.push(
            Object.assign(Object.assign({}, o), { index: t - o.length + 1 })
          );
        let a = g.fail;
        for (; a !== null; ) {
          const c = a.patterns.find(r =>
            e === "off"
              ? r.priority !== qn.Surname
              : e === "head"
                ? r.length - 1 - t === 0
                : !0
          );
  ...
  search(n, e, g = 2) {
    ...
    return g === 1 ? Vt(u) : g === 3 ? Pt(u, In(n)) : Lt(u, In(n));
  }
}
const Et = [...$t, ...Tt, ...It, ...St, ...jt, ...Ct],
  Ae = new Rt();
Ae.build(Et);
const Bt = new Me(),
  Ht = () => Bt,
  ...
  Ot = (i, n, e, g) => {
    const u = Ae.search(i, e, g);
    let h = 0;
    const t = hi(i);
    for (let s = 0; s < t.length; ) {
      const o = u[h];
      if (o && s === o.index) {
        if (o.length === 1 && o.priority <= qn.Normal) {
          const r = t[s];
          let y = "";
          ((y = ge(r, t[s - 1], t[s + 1])),
            (n[s] = { origin: r, result: y, isZh: y !== r, originPinyin: y }),
            s++,
            h++);
          continue;
        }
        const a = o.pinyin.split(" ");
        let c = 0;
        ...
        let c = "";
        ((c = ge(a, t[s - 1], t[s + 1])),
          (n[s] = { origin: a, result: c, isZh: c !== a, originPinyin: c }),
          s++);
      }
    }
  ...
  mi = (i, n) => {
    ...
    for (let h of e)
      for (let t of ft)
        if (h.startsWith(t)) {
          let s = h.slice(t.length);
          (zt.indexOf(t) !== -1 && mt.indexOf(s) !== -1 && (s = pt[s]),
            g.push(t),
            u.push(s));
          break;
        }
...
const Zt = (i, n) => {
    let e = n.nonZh;
    if (e === "removed")
      return i.filter(g => g.isZh || !_i(g.origin, n.nonZhScope));
    if (e === "consecutive") {
      for (let g = i.length - 2; g >= 0; g--) {
        ...
        !u.isZh &&
          !h.isZh &&
          _i(u.origin, n.nonZhScope) &&
          _i(h.origin, n.nonZhScope) &&
          ((u.origin += h.origin), (u.result += h.result), (h.delete = !0));
      }
      return i.filter(g => !g.delete);
    } else return i;
  },
  fe = (i, n) => (In(i) === 1 && n.multiple ? Nt(i, n.surname) : !1),
  Ut = (i, n) => {
    switch (n.pattern) {
      case "pinyin":
        break;
      case "num":
        i.forEach(e => {
          e.result = e.isZh ? bi(e.result) : "";
        });
        break;
      case "initial":
        i.forEach(e => {
          e.result = e.isZh ? mi(e.result, n.initialPattern).initial : "";
        });
        break;
      case "final":
        i.forEach(e => {
          e.result = e.isZh ? mi(e.result, n.initialPattern).final : "";
        });
        break;
      case "first":
        i.forEach(e => {
          e.result = De(e.result, e.isZh);
        });
        break;
      case "finalHead":
        i.forEach(e => {
          e.result = e.isZh ? yi(e.result).head : "";
        });
        break;
      case "finalBody":
        i.forEach(e => {
          e.result = e.isZh ? yi(e.result).body : "";
        });
        break;
      case "finalTail":
        i.forEach(e => {
          e.result = e.isZh ? yi(e.result).tail : "";
        });
        break;
    }
  },
  Kt = (i, n) => {
    switch (n.toneType) {
      ...
      case "none":
        i.forEach(e => {
          e.isZh && (e.result = xi(e.result));
        });
        break;
      case "num": {
        i.forEach(e => {
          e.isZh && (e.result = Ft(e.result, e.originPinyin));
        });
        break;
      }
    }
      ...
      : n.type === "all"
        ? i.map(g => {
            const u = g.isZh ? g.result : "",
              { initial: h, final: t } = mi(u, n.initialPattern),
              { head: s, body: o, tail: a } = yi(u);
            let c = [];
            return (
              u !== "" &&
                (c = [u].concat(Pe(g.origin, n.surname).filter(r => r !== u))),
              {
                origin: g.origin,
                pinyin: u,
                initial: h,
                final: t,
                first: De(g.result, g.isZh),
                finalHead: s,
                finalBody: o,
                finalTail: a,
                num: Number(bi(g.originPinyin)),
                isZh: g.isZh,
                polyphonic: c,
                inZhRange: !!Un.get(g.origin),
                result: g.result
              }
            );
          })
...
function Jt(i, n) {
  if (((n = Object.assign(Object.assign({}, Qt), n || {})), !Wt(i))) return i;
  ...
  let g = Array(In(i)),
    { list: u } = Ot(i, g, n.surname, n.segmentit);
  return (
    (u = Gt(u, n.toneSandhi)),
    (u = Zt(u, n)),
    fe(i, n) && (u = fe(i, n)),
...
const ng = {
  ...
  ig = 6,
  eg = (i, n, e) => {
    const g = Object.assign(Object.assign({}, ng), {});
        ...
        if (u[h - 1][t - 1]) {
          if (t !== 1 && !u[h - 1][t - 1].length) continue;
          {
            ...
            if (
              ...
              s.some(r =>
                e.lastPrecision === "any"
                  ? r.includes(n.slice(t - 1, n.length))
                  : e.lastPrecision === "start"
                    ? r.startsWith(n.slice(t - 1, n.length))
                    : e.lastPrecision === "first"
                      ? r[0] === n.slice(t - 1, n.length)
            ...
            if (
              (o === "start" &&
                s.forEach(c => {
                  ...
                  for (; r <= n.length && c.startsWith(n.slice(t - 1, r)); )
                    ((!u[h][r] || y.length > u[h][r].length) && (u[h][r] = y),
                      r++);
                }),
              o === "first" && s.some(c => c[0] === n[t - 1]))
            ) {
              const c = [...u[h - 1][t - 1], h - 1];
              (!u[h][t] || c.length > u[h][t].length) && (u[h][t] = c);
            }
            const a = s.find(c => c === n.slice(t - 1, t - 1 + c.length));
            if (a) {
              const c = [...u[h - 1][t - 1], h - 1],
                r = t - 1 + a.length;
              (!u[h][r] || c.length > u[h][r].length) && (u[h][r] = c);
            }
          }
        } else continue;
    }
...
function tg(i, n) {
  ...
  for (let t = 0; t < n.length; t++) {
    const s = n[t];
    for (; h <= s; ) (u[h].length === 2 && g++, h++);
    const o = s + g;
    u[s].length === 2 ? e.push(o - 1, o) : e.push(o);
  }
  return e;
}
var Ai;
...
const Ve = { render: ug },
  ...
  lg = Z({
    ...
    setup(i, { expose: n, emit: e }) {
      const g = M(),
        ...
        o = I(() => p => ({
          background:
            (p == null ? void 0 : p.path) === a.value ? Mi().epThemeColor : "",
          color: p.path === a.value ? "#fff" : "",
          fontSize: p.path === a.value ? "16px" : "14px"
        })),
        a = I({
          get() {
            return s.value;
      ...
      function j(p) {
        var A;
        const b =
          (A = t == null ? void 0 : t.proxy) == null
            ? void 0
            : A.$refs[`resultItemRef${p}`];
        if (!b) return 0;
        const D = b[0].offsetTop + 128;
        return D > u.value ? D - u.value : 0;
      }
      return (
        Pn(() => {
          y();
                ...
                zn(p.options, (x, D) => {
                  ...
                  return (
                    ...
                    z(
                      ...
                      [
                        (d(),
                        P(Tn(l(Mn)((A = x.meta) == null ? void 0 : A.icon)))),
                        f(
                          "span",
                          sg,
                          nn((B = x.meta) == null ? void 0 : B.title),
                          1
                        ),
                        m(l(Ve))
                      ],
  ...
  rg = gn(lg, [["__scopeId", "data-v-a865e46d"]]),
  cg = {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
...
const dg = { render: ag },
  yg = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function fg(i, n) {
  return (
    d(),
    z(
...
const zg = G({ name: "ri-arrow-up-line", render: fg }),
  mg = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function pg(i, n) {
  return (
    d(),
    z(
...
const xg = G({ name: "ri-arrow-down-line", render: pg }),
  bg = { class: "search-footer text-[#333] dark:text-white" },
  jg = { class: "search-footer-item" },
  wg = { class: "search-footer-item" },
  vg = { class: "search-footer-item" },
  qg = { key: 0, class: "search-footer-total" },
  kg = Z({
    __name: "SearchFooter",
      ...
      return (e, g) => {
        ...
        return (
          ...
          z("div", bg, [
            ...
            f("span", wg, [
              m(u, { icon: l(zg), class: "icon" }, null, 8, ["icon"]),
              m(u, { icon: l(xg), class: "icon" }, null, 8, ["icon"]),
              g[1] || (g[1] = jn(" 切换 ", -1))
            ]),
            f("span", vg, [
              m(l(dg), { class: "icon" }),
            ...
            l(n) !== "mobile" && e.total > 0
              ? (d(), z("p", qg, nn(`共 ${e.total} 项`), 1))
              : F("", !0)
          ])
        );
      };
  ...
  _g = gn(kg, [["__scopeId", "data-v-8ffe3815"]]),
  Cg = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Sg(i, n) {
  return (
    d(),
    z(
...
const Ig = G({ name: "ep-star", render: Sg }),
  Tg = { class: "history-item-title" },
  $g = Z({
      ...
      return (h, t) => {
        ...
        return (
          ...
          z(
            ...
            null,
            [
              (d(), P(Tn(l(Mn)((o = h.item.meta) == null ? void 0 : o.icon)))),
              f(
                "span",
                Tg,
                nn((a = h.item.meta) == null ? void 0 : a.title),
                1
              ),
              on(
                m(
                  s,
                  {
                    ...
                    onClick: t[0] || (t[0] = _n(c => g(h.item), ["stop"]))
                  },
                  null,
                  8,
                  ["icon"]
                ),
                [[En, h.item.type === "history"]]
              ),
              m(
                s,
                {
                  ...
                  onClick: t[1] || (t[1] = _n(c => u(h.item), ["stop"]))
                },
                null,
                8,
                ["icon"]
  ...
  ze = gn($g, [["__scopeId", "data-v-667217b9"]]),
  Mg = ["onMouseenter"],
  Lg = { class: "collect-container" },
  Ag = ["onMouseenter"],
  Pg = Z({
    ...
    setup(i, { expose: n, emit: e }) {
      const g = M(),
        ...
        a = I(() => q => ({
          background:
            (q == null ? void 0 : q.path) === r.value ? Mi().epThemeColor : "",
          color: q.path === r.value ? "#fff" : "",
          fontSize: q.path === r.value ? "16px" : "14px"
        })),
        c = I(() => ({ color: Mi().epThemeColor, fontWeight: 500 })),
        r = I({
          get() {
            return o.value;
          },
      ...
      $n(
        () => o.value,
        q => {
          q && h.value && Ce(100).then(() => (h.value = !1));
        }
      );
      const y = I(() => o.options.filter(q => q.type === "history")),
        j = I(() => o.options.filter(q => q.type === "collect"));
      function p(q) {
        t("collect", q);
      }
      function b(q) {
      ...
      function B(q) {
        var pn;
        const O =
          (pn = s == null ? void 0 : s.proxy) == null
            ? void 0
            : pn.$refs[`historyItemRef${q}`];
        if (!O) return 0;
        const mn = (nh(O) ? O[0] : O).offsetTop + 128;
      ...
      return (
        $n(
          ...
          q => {
            q.length > 1 &&
              Wn(() => {
                const O = document.querySelector(".collect-container");
                !O ||
                  K ||
                  ((K = zh.create(O, {
                    animation: 160,
                          ...
                          zn(
                            ...
                            (Q, mn) => (
                              ...
                              z(
                                ...
                                [
                                  m(ze, { item: Q, onDeleteItem: b }, null, 8, [
                                    "item"
                                  ])
                                ],
                                44,
  ...
  Dg = gn(Pg, [["__scopeId", "data-v-db41be6d"]]),
  Vg = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Rg(i, n) {
  return (
    d(),
    z(
...
const Eg = G({ name: "ri-search-line", render: Rg }),
  Bg = { class: "search-content" },
  me = "history",
  Hg = "collect",
  Vn = "menu-search-history",
  ...
  Og = Z({
    ...
    setup(i, { emit: n }) {
      const { device: e } = kn(),
        ...
        j = Ii([]),
        p = ih(mn, 300),
        b = Xn().MenuSearchHistory,
        x = M(null),
        D = I(() => eh(bn().wholeMenus)),
        A = I({
          get() {
            return u.value;
          },
      ...
      const B = I(() => t.value && y.value.length > 0),
        U = I(() => !t.value && j.value.length > 0),
        K = I(
          () =>
      ...
      function Q(C) {
        ...
        function R(en) {
          en.forEach(X => {
            (T.push(X), X.children && R(X.children));
          });
        }
        return (R(C), T);
      }
        ...
        ((y.value = C.filter(R => {
          ...
          return t.value
            ? ((en = R.meta) == null
                ...
                !Qn(
                  eg(
                    (X = R.meta) == null ? void 0 : X.title.toLocaleLowerCase(),
          ...
          (c.value =
            ((T = y.value) == null ? void 0 : T.length) > 0
              ? y.value[0].path
              : ""));
      }
      function pn() {
        ((A.value = !1),
          setTimeout(() => {
            ((y.value = []), (r.value = ""), (t.value = ""));
          }, 200));
      }
      function wn(C) {
        const R = (y.value.length ? s.value : o.value).handleScroll(C);
        a.value.setScrollTop(R);
      }
      function V() {
        const C = y.value.length > 0,
          T = C ? y.value : j.value,
          R = C ? c.value : r.value;
        return { options: T, currentPath: R, isResultOptions: C };
      }
      function un(C, T) {
        (T ? (c.value = y.value[C].path) : (r.value = j.value[C].path), wn(C));
      }
      function rn() {
        const { options: C, currentPath: T, isResultOptions: R } = V();
        if (C.length === 0) return;
        const X = (C.findIndex(L => L.path === T) - 1 + C.length) % C.length;
        un(X, R);
      }
      function Dn() {
        const { options: C, currentPath: T, isResultOptions: R } = V();
        if (C.length === 0) return;
        const X = (C.findIndex(L => L.path === T) + 1) % C.length;
        un(X, R);
      }
      function cn() {
        const { options: C, currentPath: T, isResultOptions: R } = V();
        if (C.length === 0 || T === "") return;
        const en = C.findIndex(X => X.path === T);
        en !== -1 && (R ? Cn() : Yn(), h.push(C[en].path), pn());
      }
      function Kn(C) {
        const T = C.type === me ? Vn : Fn;
        let R = q(T);
        ((R = R.filter(en => en.path !== C.path)), O(T, R), Sn());
      }
      function Bn(C) {
        let T = q(Vn),
          R = q(Fn);
        ((T = T.filter(en => en.path !== C.path)),
          O(Vn, T),
          R.some(en => en.path === C.path) ||
            (R.unshift(wi(ui({}, C), { type: Hg })), O(Fn, R)),
          Sn());
      }
      function Cn() {
        const { path: C, meta: T } = y.value.find(w => w.path === c.value),
          R = q(Vn),
          X = q(Fn).some(w => w.path === C),
          L = R.findIndex(w => w.path === C);
        X ||
          (L !== -1 && R.splice(L, 1),
          R.length >= b && R.pop(),
          R.unshift({ path: C, meta: T, type: me }),
          An().setItem(Vn, R));
      }
      function Yn() {
        let C = q(Vn);
        const T = C.findIndex(R => R.path === r.value);
        if (T !== -1) {
          const [R] = C.splice(T, 1);
          (C.unshift(R), O(Vn, C));
        }
      }
      function Sn() {
        ...
        const C = q(Vn),
          T = q(Fn);
        ((j.value = [...C, ...T]),
          (r.value = (R = j.value[0]) == null ? void 0 : R.path));
      }
      function Jn(C) {
        const T = q(Fn),
          [R] = T.splice(C.oldIndex, 1);
        (T.splice(C.newIndex, 0, R),
          An().setItem(Fn, T),
          (j.value = [...q(Vn), ...q(Fn)]),
          (r.value = R.path));
      }
        ...
        (C, T) => {
          ...
          return (
            ...
            P(
              ...
              {
                modelValue: A.value,
                "onUpdate:modelValue": T[3] || (T[3] = tn => (A.value = tn)),
                top: "5vh",
                class: "pure-search-dialog",
                "show-close": !1,
                width: l(e) === "mobile" ? "80vw" : "40vw",
                "before-close": pn,
                style: { borderRadius: "6px" },
                "append-to-body": "",
                onOpened: T[4] || (T[4] = tn => x.value.focus()),
                onClosed: T[5] || (T[5] = tn => x.value.blur())
              },
              {
                footer: _(() => [
                  m(_g, { total: y.value.length }, null, 8, ["total"])
                ]),
                default: _(() => [
                  m(
                    en,
  ...
  Ng = gn(Og, [["__scopeId", "data-v-e38615b0"]]),
  Wi = Z({
    __name: "index",
    setup(i) {
      const { bool: n, toggle: e } = ct();
      function g() {
        e();
      }
      return (u, h) => {
        const t = k("IconifyIconOffline");
        return (
          d(),
          z("div", null, [
            f(
  ...
  Wg = { class: "notice-container-text" },
  Zg = { class: "notice-text-title text-[#000000d9] dark:text-white" },
  Ug = { class: "notice-text-datetime text-[#00000073] dark:text-white" },
  Kg = Z({
    __name: "NoticeItem",
          ...
          z("div", Fg, [
            ...
            f("div", Wg, [
              f("div", Zg, [
                ...
                (p = i.noticeItem) != null && p.extra
                  ? (d(),
                    P(
                      j,
                      {
                        key: 0,
                        type: (b = i.noticeItem) == null ? void 0 : b.status,
                        size: "small",
                      ...
                      },
                      {
                        default: _(() => {
                          ...
                          return [
                            jn(
                              nn((x = i.noticeItem) == null ? void 0 : x.extra),
                              1
                            )
                          ];
                        }),
                  ...
                  default: _(() => [
                    f(
                      "div",
                      {
                        ...
                        onMouseover:
                          c[0] || (c[0] = x => o(x, i.noticeItem.description))
                      },
                      nn(i.noticeItem.description),
                      545
                    )
                  ]),
                  _: 1
              ...
              f("div", Ug, nn(i.noticeItem.datetime), 1)
            ])
          ])
        );
      };
  ...
  Yg = gn(Kg, [["__scopeId", "data-v-dd3c145c"]]),
  Xg = { key: 0 },
  Gg = Z({
    __name: "NoticeList",
    props: {
            ...
            z("div", Xg, [
              ...
              z(
                ...
                zn(
                  ...
                  (u, h) => (
                    d(),
                    P(Yg, { key: h, noticeItem: u }, null, 8, ["noticeItem"])
                  )
                ),
                128
              ))
  ...
  Qg = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Jg(i, n) {
  return (
    d(),
    z(
...
const nu = G({ name: "ep-bell", render: Jg }),
  iu = { class: "header-notice-icon" },
  eu = { key: 1 },
  hu = { class: "noticeList-container" },
  tu = Z({
    __name: "index",
    setup(i) {
      var h;
  ...
  Zi = gn(tu, [["__scopeId", "data-v-9d4bfb62"]]),
  gu = { key: 0, class: "flex justify-center items-center" },
  Pi = Z({
      ...
      return (n, e) =>
        i.extraIcon
          ? (d(),
            z("div", gu, [
              (d(),
              P(Tn(l(Mn)(vn(i.extraIcon))), { class: "w-[30px] h-[30px]" }))
            ]))
          : F("", !0);
    }
  }),
  Ui = Z({
    ...
    setup(i) {
      const n = M(),
        { toggle: e, isFullscreen: g, Fullscreen: u, ExitFullscreen: h } = kn();
      return (
        (g.value = !!(
          ...
          return (
            ...
            z(
              "span",
              {
                ...
                onClick: s[0] || (s[0] = (...a) => l(e) && l(e)(...a))
              },
              [m(o, { icon: n.value }, null, 8, ["icon"])]
            )
          );
        }
      );
...
const Ki = G({ name: "ri-logout-circle-r-line", render: ou }),
  su = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function lu(i, n) {
  return (
    d(),
    z(
...
const Yi = G({ name: "ri-settings-3-line", render: lu }),
  ru = { key: 0, class: "horizontal-header" },
  cu = { class: "select-none" },
  au = { class: "horizontal-header-right" },
  du = { class: "el-dropdown-link navbar-bg-hover select-none" },
  yu = ["src"],
  fu = { key: 0, class: "dark:text-white" },
  zu = Z({
    __name: "NavMix",
    setup(i) {
      const n = M(),
      ...
      function y(j) {
        var x, D, A;
        const p = bn().wholeMenus,
          b = Oi(j, p)[0];
        e.value = Qn((x = g.meta) == null ? void 0 : x.activePath)
          ? (A = (D = fi(b, p)) == null ? void 0 : D.children[0]) == null
            ? void 0
            : A.path
          : g.meta.activePath;
      }
      return (
        ...
        $n(
          () => [g.path, bn().wholeMenus],
          () => {
            y(g.path);
          }
        ),
        (j, p) => {
          const b = k("el-menu-item"),
            x = k("el-menu"),
            D = k("IconifyIconOffline"),
            A = k("el-dropdown-item"),
          ...
          return l(u) !== "mobile"
            ? on(
                ...
                z("div", ru, [
                        ...
                        z(
                          ...
                          zn(
                            ...
                            q => (
                              ...
                              P(
                                b,
                                { key: q.path, index: l(s)(q) || q.redirect },
                                {
                                  title: _(() => [
                                    vn(q.meta.icon)
                                      ? (d(),
                  ...
                  f("div", au, [
                    m(Wi, { id: "header-search" }),
                    m(Ui, { id: "full-screen" }),
                    m(Zi, { id: "header-notice" }),
                    m(
                      U,
                      { trigger: "click" },
                      {
                        ...
                        default: _(() => [
                          f("span", du, [
                            f(
                              "img",
                              { src: l(a), style: ln(l(r)) },
                              null,
                              12,
                              yu
                            ),
                            l(o) ? (d(), z("p", fu, nn(l(o)), 1)) : F("", !0)
                          ])
                        ]),
                        _: 1
                      }
                    ...
                    f(
                      "span",
                      {
                        ...
                        title: "打开系统配置",
                        onClick: p[0] || (p[0] = (...q) => l(t) && l(t)(...q))
                      },
                      [m(D, { icon: l(Yi) }, null, 8, ["icon"])]
                    )
                  ])
                ])),
                [[K, l(bn)().wholeMenus.length === 0]]
              )
            : F("", !0);
        }
      );
  ...
  mu = gn(zu, [["__scopeId", "data-v-2f0010d7"]]),
  pu = ["onClick"],
  xu = Z({
      ...
      const n = Ei(),
        ...
        t = () => {
          ...
          Object.keys(n.query).length > 0
            ? h.forEach(r => {
                Gn(n.query, r == null ? void 0 : r.query) && (o = vn(r));
              })
            : Object.keys(n.params).length > 0
              ? h.forEach(r => {
                  Gn(n.params, r == null ? void 0 : r.params) && (o = vn(r));
                })
              : (o = fi(g.currentRoute.value.path, u));
          const a = Oi(g.currentRoute.value.name, u, "name"),
            c = [];
          (a.forEach(r => {
            r !== "/" && c.push(fi(r, u));
          }),
              ...
              (o != null && o.query) ||
                ...
                (r != null &&
                  ...
                  r.children.forEach(j => {
                    var p, b;
                    ((p = j == null ? void 0 : j.meta) == null
                      ? void 0
                      : p.title) ===
                      ((b = r == null ? void 0 : r.meta) == null
                        ? void 0
                        : b.title) && c.splice(y, 1);
                  }));
            }),
            (e.value = c.filter(
              r =>
        ...
        s = o => {
          const { redirect: a, name: c, path: r } = o;
          a
            ? g.push(a)
            : c
              ? o.query
                ? g.push({ name: c, query: o.query })
                : o.params
                  ? g.push({ name: c, params: o.params })
                  : g.push({ name: c })
              : g.push({ path: r });
        };
      return (
  ...
  bu = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function ju(i, n) {
  return (
    d(),
    z(
...
const Re = G({ name: "ri-menu-fold-fill", render: ju }),
  wu = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function vu(i, n) {
  return (
    d(),
    z(
...
const qu = G({ name: "ri-menu-unfold-fill", render: vu }),
  ku = ["title"],
  _u = Z({
  ...
  Cu = { class: "navbar bg-[#fff] shadow-xs shadow-[rgba(0,21,41,0.08)]" },
  Su = { key: 3, class: "vertical-header-right" },
  Iu = { class: "el-dropdown-link navbar-bg-hover select-none" },
  Tu = ["src"],
  $u = { key: 0, class: "dark:text-white" },
  Mu = Z({
    __name: "index",
    setup(i) {
      const {
      ...
      return (c, r) => {
        const y = k("IconifyIconOffline"),
          j = k("el-dropdown-item"),
          p = k("el-dropdown-menu"),
          b = k("el-dropdown");
        return (
          d(),
          z("div", Cu, [
            l(e) === "mobile"
              ...
              : F("", !0),
            l(n) !== "mix" && l(e) !== "mobile"
              ? (d(), P(xu, { key: 1, class: "breadcrumb-container" }))
              : F("", !0),
            l(n) === "mix" ? (d(), P(mu, { key: 2 })) : F("", !0),
            l(n) === "vertical"
              ? (d(),
                z("div", Su, [
                  m(Wi, { id: "header-search" }),
                    ...
                    { trigger: "click" },
                    {
                      ...
                      default: _(() => [
                        f("span", Iu, [
                          f(
                            "img",
                            { src: l(s), style: ln(l(o)) },
                            null,
                            12,
                            Tu
                          ),
                          l(t) ? (d(), z("p", $u, nn(l(t)), 1)) : F("", !0)
                        ])
                      ]),
                      _: 1
                    }
                  ...
                  f(
                    "span",
                    {
                      class: "set-icon navbar-bg-hover",
                      title: "打开系统配置",
                      onClick: r[0] || (r[0] = (...x) => l(u) && l(u)(...x))
                    },
                    [m(y, { icon: l(Yi) }, null, 8, ["icon"])]
                  )
                ]))
              : F("", !0)
          ])
  ...
  Lu = gn(Mu, [["__scopeId", "data-v-670ea7d9"]]),
  si = new Map(),
  Au = () => {
    function i(g, u) {
      si.set(g, u);
    ...
    function n(g) {
      return g ? si.get(g) : [...si.entries()];
    }
    function e(g) {
      si.delete(g);
    }
    return { setMap: i, getMap: n, delMap: e, MAP: si };
  },
  Pu = { class: "w-full h-full" },
  Du = Z({
    __name: "index",
    ...
    setup(i) {
      const n = i,
        e = Ii([]),
        { setMap: g, getMap: u, MAP: h, delMap: t } = Au(),
        s = I(() => {
          var a, c;
          return (
            Xn().KeepAlive &&
        ...
        o = I(() => !s.value && n.currComp);
      return (
        $n(Ln().multiTags, a => {
          if (!Array.isArray(a) || !s.value) return;
          if (
            a.filter(r => {
              var y;
              return (y = r.meta) == null ? void 0 : y.frameSrc;
            }).length < h.size
          )
            for (const r of h.keys())
              a.some(y => y.path === r) || (t(r), (e.value = u()));
        }),
        $n(
          () => n.currRoute.fullPath,
          a => {
            const r = Ln().multiTags.filter(y => {
              var j;
  ...
  Eu = Z({
    ...
    setup(i) {
      ...
      return (e, g) => (
        d(),
        z("footer", Vu, [
          g[0] || (g[0] = jn(" Copyright © 2020-present ", -1)),
          f("a", Ru, "  " + nn(l(n)), 1)
        ])
      );
    }
  }),
  xe = gn(Eu, [["__scopeId", "data-v-d6a7e7e5"]]),
  Bu = { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24" };
function Hu(i, n) {
  return (
    d(),
    z(
      ...
      n[0] ||
        (n[0] = [
          f("path", { fill: "none", d: "M0 0h24v24H0z" }, null, -1),
          f(
            "path",
            {
...
const Ee = { render: Hu },
  ...
  Fu = Z({
    ...
    setup(i) {
      const n = i,
        { showModel: e } = $e(),
        { $storage: g, $config: u } = ci(),
        h = I(() => (u == null ? void 0 : u.KeepAlive)),
        t = I(() => p => p.meta.transition),
        s = I(() => (g == null ? void 0 : g.configure.hideTabs)),
        o = I(() => (g == null ? void 0 : g.configure.hideFooter)),
        a = I(() => (g == null ? void 0 : g.configure.stretch)),
        c = I(() => (g == null ? void 0 : g.layout.layout) === "vertical"),
        r = I(() =>
          Ti(a.value) ? a.value + "px" : a.value ? "1440px" : "100%"
        ),
        y = I(() => [
          s.value && c ? "padding-top: 48px;" : "",
          !s.value && c
            ? e.value == "chrome"
              ? "padding-top: 85px;"
              : "padding-top: 81px;"
            : "",
          s.value && !c.value ? "padding-top: 48px;" : "",
          !s.value && !c.value
            ? e.value == "chrome"
              ? "padding-top: 85px;"
              : "padding-top: 81px;"
          ...
          n.fixedHeader
            ? ""
            : `padding-top: 0;${s.value ? "min-height: calc(100vh - 48px);" : "min-height: calc(100vh - 86px);"}`
        ]),
        j = Z({
          ...
          render() {
            var D, A, B;
            const p =
                ((D = t.value(this.route)) == null ? void 0 : D.name) ||
                "fade-transform",
              b =
                (A = t.value(this.route)) == null ? void 0 : A.enterTransition,
              x =
                (B = t.value(this.route)) == null ? void 0 : B.leaveTransition;
            return ei(
              Hi,
              {
                name: b ? "pure-classes-transition" : p,
                enterActiveClass: b ? `animate__animated ${b}` : void 0,
      ...
      return (p, b) => {
        ...
        return (
          ...
          z(
            ...
            [
              m(A, null, {
                default: _(({ Component: B, route: U }) => [
                  m(
                    Du,
                    { currComp: B, currRoute: U },
                    {
                      default: _(({ Comp: K, fullPath: q, frameInfo: O }) => [
                        i.fixedHeader
                          ? (d(),
                            P(
                              D,
              ...
              !o.value && !i.fixedHeader ? (d(), P(xe, { key: 0 })) : F("", !0)
            ],
            6
          )
        );
  ...
  be = gn(Fu, [["__scopeId", "data-v-7642e8be"]]),
  Wu = {
    class:
                  ...
                  [
                    ...
                    f("div", Zu, [
                      on(
                        ...
                        P(
                          a,
                          { type: "danger", text: "", bg: "", onClick: l(u) },
                          {
                            default: _(
                              () => t[2] || (t[2] = [jn(" 清空缓存 ", -1)])
                            ),
  ...
  Ku = gn(Uu, [["__scopeId", "data-v-57b548f3"]]),
  Yu = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Xu(i, n) {
  return (
    d(),
    z(
...
const Gu = G({ name: "ep-check", render: Xu }),
  Qu = { viewBox: "0 0 24 24", width: "20", height: "20" };
function Ju(i, n) {
  return (
    d(),
    z(
...
const je = G({ name: "ri-arrow-left-s-line", render: Ju }),
  no = { viewBox: "0 0 24 24", width: "20", height: "20" };
function io(i, n) {
  return (
    d(),
    z(
...
const we = G({ name: "ri-arrow-right-s-line", render: io }),
  eo = {
    xmlns: "http://www.w3.org/2000/svg",
    width: "16",
    height: "16",
...
const to = { render: ho },
  ...
  co = Z({
    ...
    setup(i) {
      ...
      if (l(a)) {
        const L = l(a).layout,
          w = l(a).theme;
        (document.documentElement.setAttribute("data-theme", w), Cn(L));
      }
      const p = M(
          (R = (T = g.configure) == null ? void 0 : T.showModel) != null
            ? R
            : "smart"
        ),
        b = M(
          (X = (en = g.configure) == null ? void 0 : en.showLogo) != null
            ? X
            : !0
        ),
        x = Di({
        ...
        D = I(() => L => ({ background: L })),
        A = I(() => L => !(L === "light" && e.value));
      function B(L, w) {
        const tn = g.configure;
        ((tn[L] = w), (g.configure = tn));
      }
      const U = L => {
          const w = document.querySelector("html");
          (r(x.greyVal, "html-grey", w), B("grey", L));
        },
        K = L => {
          const w = document.querySelector("html");
          (r(x.weakVal, "html-weakness", w), B("weak", L));
        },
        q = () => {
          const L = x.tabsVal;
          (B("hideTabs", L), fn.emit("tagViewsChange", L));
        },
        O = () => {
          const L = x.hideFooter;
          B("hideFooter", L);
        },
        Q = () => {
          const L = x.multiTagsCache;
          (B("multiTagsCache", L), Ln().multiTagsCacheChange(L));
        };
      function mn({ option: L }) {
        const { value: w } = L;
        ((p.value = w), B("showModel", w), fn.emit("tagViewsShowModel", w));
      }
      function pn() {
        (l(b) ? B("showLogo", !0) : B("showLogo", !1),
          fn.emit("logoChange", l(b)));
      }
      function wn(L) {
        L.forEach(w => {
          r(!1, "is-select", l(w));
      ...
      const V = I(() => [
        ...
        Dn = I(
          () => L =>
            L === a.value.theme && a.value.theme !== "light"
              ? "#fff"
              : L === a.value.theme && a.value.theme === "light"
                ? "#1d2b45"
                : "transparent"
      ...
      function Cn(L) {
        ...
        ((a.value.layout = L),
          ...
          (g.layout = {
            ...
            sidebarStatus: (tn = g.layout) == null ? void 0 : tn.sidebarStatus,
      ...
      $n(g, ({ layout: L }) => {
        switch (L.layout) {
          case "vertical":
            (r(!0, "is-select", l(h)), ni(wn([t]), 50), ni(wn([u]), 50));
            break;
          case "horizontal":
            (r(!0, "is-select", l(t)), ni(wn([h]), 50), ni(wn([u]), 50));
            break;
          case "mix":
            (r(!0, "is-select", l(u)), ni(wn([h]), 50), ni(wn([t]), 50));
            break;
        }
      });
      const Yn = window.matchMedia("(prefers-color-scheme: dark)");
      function Sn() {
        o.value === "system" &&
          (Yn.matches ? (s.value = !0) : (s.value = !1), y(o.value));
      }
      function Jn() {
        Yn.removeEventListener("change", Sn);
      }
      function C() {
        (Sn(), Jn(), Yn.addEventListener("change", Sn));
      }
      return (
        Te(() => {
          Wn(() => {
        ...
        gh(() => Jn),
        (L, w) => {
          const tn = k("IconifyIconOffline"),
            Hn = k("el-icon"),
            On = k("el-input-number"),
            dn = k("el-switch"),
            ti = Zn("tippy"),
            ji = Zn("ripple");
          return (
            ...
            P(Ku, null, {
              default: _(() => [
                f("div", go, [
                  f("p", { class: J(cn.value) }, "整体风格", 2),
                  m(
                    l(ki),
                    {
                      resize: "",
                      class: "select-none",
                      modelValue: l(o) === "system" ? 2 : l(s) ? 1 : 0,
                      options: Kn.value,
                      onChange:
                        w[0] ||
                        (w[0] = W => {
                  ...
                  f("p", { class: J(["mt-5!", cn.value]) }, "主题色", 2),
                  f("ul", uo, [
                    (d(!0),
                    z(
                      sn,
                      ...
                      zn(l(c), (W, v) =>
                        on(
                          ...
                          z(
                            ...
                            {
                              key: v,
                              style: ln(D.value(W.color)),
                              onClick: S => l(j)(W.themeColor)
                            },
                            [
                              m(
                                Hn,
                                {
                                  ...
                                  size: 17,
                                  color: Dn.value(W.themeColor)
                                },
                                {
                                  default: _(() => [
                                    m(tn, { icon: l(Gu) }, null, 8, ["icon"])
                                  ]),
                                  _: 2
                                },
                                1032,
                          ...
                          [[En, A.value(W.themeColor)]]
                        )
                      ),
                      128
                    ))
                  ]),
                  f("p", { class: J(["mt-5!", cn.value]) }, "导航模式", 2),
                  f("ul", so, [
                    on(
                      (d(),
                      z(
                        "li",
                        {
                          ...
                          ref: h,
                          class: J(
                            l(a).layout === "vertical" ? "is-select" : ""
                          ),
                          onClick: w[1] || (w[1] = W => Cn("vertical"))
                        },
                        w[13] ||
                          (w[13] = [
                            f("div", null, null, -1),
                      ...
                      [[ti, { content: "左侧菜单，亲切熟悉", zIndex: 41e3 }]]
                    ),
                    l(n) !== "mobile"
                      ? on(
                          (d(),
                          z(
                            "li",
                            {
                              ...
                              ref: t,
                              class: J(
                                l(a).layout === "horizontal" ? "is-select" : ""
                              ),
                              onClick: w[2] || (w[2] = W => Cn("horizontal"))
                            },
                            w[14] ||
                              (w[14] = [
                                f("div", null, null, -1),
                      ...
                      ? on(
                          ...
                          z(
                            "li",
                            {
                              ...
                              ref: u,
                              class: J(
                                l(a).layout === "mix" ? "is-select" : ""
                              ),
                              onClick: w[3] || (w[3] = W => Cn("mix"))
                            },
                            w[15] ||
                              (w[15] = [
                                f("div", null, null, -1),
                  ...
                  l(Rn)().getViewportWidth > 1280
                    ? (d(),
                      z("span", lo, [
                        f("p", { class: J(["mt-5!", cn.value]) }, "页宽", 2),
                        m(
                          l(ki),
                          {
                            resize: "",
                            class: "mb-2 select-none",
                            modelValue: l(Ti)(x.stretch) ? 1 : 0,
                            options: V.value,
                            onChange: rn
                          },
                          null,
                          ...
                          ? (d(),
                            P(
                              On,
                              {
                                ...
                                "onUpdate:modelValue":
                                  w[4] || (w[4] = W => (x.stretch = W)),
                                min: 1280,
                                max: 1600,
                                "controls-position": "right",
                                onChange: w[5] || (w[5] = W => un(W))
                              },
                              null,
                              8,
                              ["modelValue"]
                          ...
                          : on(
                              ...
                              z(
                                "button",
                                {
                                  ...
                                  onClick: w[6] || (w[6] = W => un(!x.stretch))
                                },
                                [
                                  f(
                                    "div",
                              ...
                              [[ji, { class: "text-gray-300" }]]
                            )
                      ]))
                    : F("", !0),
                  f("p", { class: J(["mt-4!", cn.value]) }, "页签风格", 2),
                  m(
                    l(ki),
                    {
                      resize: "",
                      class: "select-none",
                      modelValue:
                        p.value === "smart" ? 0 : p.value === "card" ? 1 : 2,
                      options: Bn.value,
                      onChange: mn
                    },
                    null,
                    ...
                    f("li", null, [
                      ...
                      m(
                        dn,
                        {
                          ...
                          "onUpdate:modelValue":
                            w[12] || (w[12] = W => (x.multiTagsCache = W)),
                          "inline-prompt": "",
                          "active-text": "开",
                          "inactive-text": "关",
                          onChange: Q
  ...
  ao = gn(co, [["__scopeId", "data-v-a968dd4e"]]),
  yo = ["src"],
  fo = { class: "sidebar-title" },
  zo = ["src"],
  mo = { class: "sidebar-title" },
  po = Z({
    __name: "SidebarLogo",
    props: { collapse: Boolean },
    setup(i) {
      const { title: n, getLogo: e } = kn();
      return (g, u) => {
        ...
        return (
          ...
          z(
            "div",
            { class: J(["sidebar-logo-container", { collapses: i.collapse }]) },
            [
              m(
                Hi,
  ...
  xo = gn(po, [["__scopeId", "data-v-4dd8e86d"]]);
var Ci, ve;
function bo() {
  if (ve) return Ci;
  ve = 1;
  ...
  function n(u, h) {
    for (var t = "", s = 0, o = -1, a = 0, c, r = 0; r <= u.length; ++r) {
      if (r < u.length) c = u.charCodeAt(r);
      else {
        if (c === 47) break;
        c = 47;
      }
  ...
  function e(u, h) {
    var t = h.dir || h.root,
      s = h.base || (h.name || "") + (h.ext || "");
    return t ? (t === h.root ? t + s : t + u + s) : s;
  }
  var g = {
    resolve: function () {
      for (
        var h = "", t = !1, s, o = arguments.length - 1;
        o >= -1 && !t;
        o--
      ) {
        var a;
    ...
    join: function () {
      ...
      for (var h, t = 0; t < arguments.length; ++t) {
        var s = arguments[t];
        (i(s), s.length > 0 && (h === void 0 ? (h = s) : (h += "/" + s)));
      }
    ...
    relative: function (h, t) {
      if (
        ...
        return "";
      for (var s = 1; s < h.length && h.charCodeAt(s) === 47; ++s);
      for (
        var o = h.length, a = o - s, c = 1;
        c < t.length && t.charCodeAt(c) === 47;
        ++c
      );
      for (
        var r = t.length, y = r - c, j = a < y ? a : y, p = -1, b = 0;
        b <= j;
        ++b
      ) {
        if (b === j) {
          if (y > j) {
            if (t.charCodeAt(c + b) === 47) return t.slice(c + b + 1);
            if (b === 0) return t.slice(c + b);
          } else
            a > j &&
              (h.charCodeAt(s + b) === 47 ? (p = b) : b === 0 && (p = 0));
          break;
        }
        var x = h.charCodeAt(s + b),
          D = t.charCodeAt(c + b);
        if (x !== D) break;
        x === 47 && (p = b);
      }
      var A = "";
      for (b = s + p + 1; b <= o; ++b)
        (b === o || h.charCodeAt(b) === 47) &&
          (A.length === 0 ? (A += "..") : (A += "/.."));
      return A.length > 0
        ? A + t.slice(c + p)
        : ((c += p), t.charCodeAt(c) === 47 && ++c, t.slice(c));
    },
    ...
    dirname: function (h) {
      if ((i(h), h.length === 0)) return ".";
      for (
        var t = h.charCodeAt(0), s = t === 47, o = -1, a = !0, c = h.length - 1;
        c >= 1;
        --c
      )
      ...
      return o === -1 ? (s ? "/" : ".") : s && o === 1 ? "//" : h.slice(0, o);
    },
    basename: function (h, t) {
      ...
      if (t !== void 0 && t.length > 0 && t.length <= h.length) {
        ...
        return (s === o ? (o = y) : o === -1 && (o = h.length), h.slice(s, o));
      } else {
        for (c = h.length - 1; c >= 0; --c)
        ...
        return o === -1 ? "" : h.slice(s, o);
      }
    },
    extname: function (h) {
      i(h);
      for (
        var t = -1, s = 0, o = -1, a = !0, c = 0, r = h.length - 1;
        r >= 0;
        --r
      ) {
        var y = h.charCodeAt(r);
        if (y === 47) {
          if (!a) {
            s = r + 1;
            break;
    ...
    parse: function (h) {
      ...
      o ? ((t.root = "/"), (a = 1)) : (a = 0);
      for (
        var c = -1, r = 0, y = -1, j = !0, p = h.length - 1, b = 0;
        p >= a;
        --p
      ) {
        if (((s = h.charCodeAt(p)), s === 47)) {
          if (!j) {
            r = p + 1;
            break;
          }
        ...
        (b === 1 && c === y - 1 && c === r + 1)
          ? y !== -1 &&
            (r === 0 && o
              ...
              : (t.base = t.name = h.slice(r, y)))
          : (r === 0 && o
              ? ((t.name = h.slice(1, c)), (t.base = h.slice(1, y)))
              : ((t.name = h.slice(r, c)), (t.base = h.slice(r, y))),
            (t.ext = h.slice(c, y))),
        r > 0 ? (t.dir = h.slice(0, r - 1)) : o && (t.dir = "/"),
        t
      );
    },
    sep: "/",
...
const wo = Z({
    ...
    setup(i) {
      const n = i,
        ...
        t = () => ui({ content: ei(e.content || e.default) }, n.tippyProps);
      function s(o) {
        h(o.target)
      ...
      return (
        Pn(() => {
          var o;
          u.value = oh((o = g.value) == null ? void 0 : o.$el, t());
        }),
        (o, a) => {
          const c = k("el-text");
          return (
            ...
            P(
              ...
              $i(
                ...
                { ref_key: "textRef", ref: g, onMouseover: _n(s, ["self"]) }
              ),
              { default: _(() => [ri(o.$slots, "default")]), _: 3 },
              16
            )
          );
        }
  ...
  vo = Z({
    ...
    setup(i) {
      ...
      return (u, h) => (
        d(),
        P(
          Tn(e.value ? "a" : "router-link"),
          lh(rh(g(u.to))),
          { default: _(() => [ri(u.$slots, "default")]), _: 3 },
          16
        )
      );
    }
  }),
  qo = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function ko(i, n) {
  return (
    d(),
    z(
...
const _o = G({ name: "ep-arrow-up-bold", render: ko }),
  Co = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function So(i, n) {
  return (
    d(),
    z(
...
const Io = G({ name: "ep-arrow-down-bold", render: So }),
...
const Mo = G({ name: "ep-arrow-left-bold", render: $o }),
  Lo = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function Ao(i, n) {
  return (
    d(),
    z(
...
const Po = G({ name: "ep-arrow-right-bold", render: Ao }),
  Be = Z({
    __name: "SidebarItem",
    props: {
      item: { type: Object },
    ...
    setup(i) {
      const n = ah(),
        { layout: e, isCollapse: g, tooltipEffect: u, getDivStyle: h } = kn(),
        t = i,
        s = I(() => ({ width: "100%", display: "flex", alignItems: "center" })),
        o = I(() => ({
          display: "flex",
        ...
        a = I(() => {
          const p = t.item,
            b = "w-full! text-inherit!";
          return e.value !== "horizontal" &&
            g.value &&
            !vn(p.meta.icon) &&
            ((e.value === "vertical" && p.parentId === null) ||
              (e.value === "mix" && p.pathList.length === 2))
            ? `${b} min-w-[54px]! text-center! px-3!`
            : b;
        }),
        c = I(() => {
          var p;
          return (p = Xn()) != null && p.MenuArrowIconNoTransition
            ? {
                "expand-close-icon": Mn(Io),
                "expand-open-icon": Mn(_o),
                "collapse-close-icon": Mn(Po),
                "collapse-open-icon": Mn(Mo)
              }
            : "";
        }),
        r = M(null);
      function y(p = [], b) {
        var D, A;
        const x = p.filter(B => ((r.value = B), !0));
        return (A = (D = x[0]) == null ? void 0 : D.meta) != null &&
          A.showParent
          ? !1
          : x.length === 1
            ? !0
            : x.length === 0
              ? ((r.value = wi(ui({}, b), { path: "", noShowingChildren: !0 })),
                !0)
              : !1;
      }
      function j(p) {
        const b = /^http(s?):\/\//;
        return b.test(p) || b.test(t.basePath)
          ? p || t.basePath
          : jo.posix.resolve(t.basePath, p);
      }
      return (p, b) => {
        const x = k("el-text"),
          D = k("el-menu-item"),
                        ...
                        f(
                          ...
                          [
                            m(
                              l(qe),
                              {
                                tippyProps: { offset: [0, -10], theme: l(u) },
                                class: "w-full! text-inherit!"
                              },
                              {
                                default: _(() => [
                                  jn(nn(r.value.meta.title), 1)
                                ]),
                                _: 1
                              },
                              8,
                      ...
                      default: _(() => {
                        ...
                        return [
                          vn(i.item.meta.icon)
                            ...
                            : F("", !0),
                          (!((U = i.item) != null && U.meta.icon) &&
                            l(g) &&
                            l(e) === "vertical" &&
                            ((q = (K = i.item) == null ? void 0 : K.pathList) ==
                            null
                              ? void 0
                              : q.length) === 1) ||
                          (!r.value.meta.icon &&
                            l(g) &&
                            l(e) === "mix" &&
                            ((Q = (O = i.item) == null ? void 0 : O.pathList) ==
                            null
                              ? void 0
                              : Q.length) === 2)
                            ? (d(),
                    ...
                    vn(i.item.meta.icon)
                      ? (d(),
                        z(
                          ...
                          [
                            (d(),
                            P(Tn(l(Mn)(i.item.meta && vn(i.item.meta.icon)))))
                          ],
                          4
                        ))
                      : F("", !0),
                    (
                      l(e) === "mix" && vn(i.item.meta.icon)
                        ? !l(g) ||
                          ((K = (U = i.item) == null ? void 0 : U.pathList) ==
                          null
                            ? void 0
                            : K.length) !== 2
                        : !(
                      ...
                      ? (d(),
                        P(
                          ...
                          {
                            default: _(() => [jn(nn(i.item.meta.title), 1)]),
                            _: 1
                          },
                          8,
                          ["tippyProps", "class"]
  ...
  Do = { class: "left-collapse" },
  Vo = Z({
    __name: "SidebarLeftCollapse",
    props: { isActive: { type: Boolean, default: !1 } },
    emits: ["toggleClick"],
    setup(i, { emit: n }) {
      const { tooltipEffect: e } = kn(),
        g = I(() => [
          "ml-4",
          "mb-1",
          "w-[16px]",
        ...
        h = I(() => {
          var o;
          return (o = u.layout) == null ? void 0 : o.themeColor;
        }),
        t = n,
        s = () => {
          t("toggleClick");
            ...
            on(
              m(
                c,
                {
                  ...
                  style: ln({
                    transform: o.isActive ? "none" : "rotateY(180deg)"
                  }),
                  onClick: s
                },
                null,
  ...
  Ro = gn(Vo, [["__scopeId", "data-v-8c3f5ed6"]]),
  Eo = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function Bo(i, n) {
  return (
    d(),
    z(
...
const Ho = G({ name: "ri-arrow-left-double-fill", render: Bo }),
  Oo = Z({
    ...
    setup(i, { emit: n }) {
      ...
      return (o, a) => {
        ...
        return on(
          (d(),
          z("div", { class: "center-collapse", onClick: s }, [
            m(
              c,
              {
                icon: l(Ho),
                class: J([g.value, h.value === "light" ? "" : "text-primary"]),
                style: ln({
                  transform: o.isActive ? "none" : "rotateY(180deg)"
                })
              },
  ...
  No = gn(Oo, [["__scopeId", "data-v-762cf2f1"]]),
  Fo = Z({
    __name: "NavVertical",
    setup(i) {
      var b, x;
      const n = Ei(),
        ...
        g = M(
          (x =
            (b = An().getItem(`${ii()}configure`)) == null
              ? void 0
              : b.showLogo) != null
            ? x
            : !0
        ...
        c = M([]),
        r = I(() =>
          h.layout === "mix" && u.value !== "mobile" ? c.value : bn().wholeMenus
        ),
        y = I(() => (h.layout === "mix" ? !1 : r.value.length === 0)),
        j = I(() => {
          var D;
          return Qn((D = n.meta) == null ? void 0 : D.activePath)
            ? n.path
            : n.meta.activePath;
        });
      function p() {
        let D = "";
        ((D = j.value), (c.value = []));
        const A = Oi(D, bn().wholeMenus),
          B = fi(A[0] || D, bn().wholeMenus);
        B != null && B.children && (c.value = B == null ? void 0 : B.children);
      }
      return (
        $n(
          () => [n.path, bn().wholeMenus],
          () => {
            n.path.includes("/redirect") || (p(), o(n.path));
          }
        ),
        Pn(() => {
          (p(),
          ...
          return on(
            ...
            z(
              "div",
              {
                ...
                onMouseenter:
                  A[0] || (A[0] = _n(q => (e.value = !0), ["prevent"])),
                onMouseleave:
                  A[1] || (A[1] = _n(q => (e.value = !1), ["prevent"]))
              },
              [
                g.value
                  ? (d(),
                    P(xo, { key: 0, collapse: l(t) }, null, 8, ["collapse"]))
                  : F("", !0),
                m(
                  U,
                  {
                    "wrap-class": "scrollbar-wrapper",
                    class: J([l(u) === "mobile" ? "mobile" : "pc"])
                  },
                  {
                    default: _(() => [
                      m(
  ...
  Wo = gn(Fo, [["__scopeId", "data-v-f94a3619"]]),
  Zo = { class: "horizontal-header" },
  Uo = ["src"],
  Ko = { class: "horizontal-header-right" },
  Yo = { class: "el-dropdown-link navbar-bg-hover" },
  Xo = ["src"],
  Go = { key: 0, class: "dark:text-white" },
  Qo = Z({
    ...
    setup(i) {
      ...
      const n = M(),
        e = M(
          (p =
            (j = An().getItem(`${ii()}configure`)) == null
              ? void 0
              : j.showLogo) != null
            ? p
            : !0
        ...
        y = I(() => {
          var b;
          return Qn((b = g.meta) == null ? void 0 : b.activePath)
            ? g.path
            : g.meta.activePath;
        });
      return (
        ...
        (b, x) => {
          const D = k("el-menu"),
            A = k("IconifyIconOffline"),
            B = k("el-dropdown-item"),
            U = k("el-dropdown-menu"),
            K = k("el-dropdown"),
            q = Zn("loading");
          return on(
            (d(),
                ...
                ? (d(),
                  z(
                    "div",
                    {
                      ...
                      onClick: x[0] || (x[0] = (...O) => l(c) && l(c)(...O))
                    },
                    [
                      f("img", { src: l(s)(), alt: "logo" }, null, 8, Uo),
                      f("span", null, nn(l(u)), 1)
                    ]
                  ))
                : F("", !0),
              m(
                    ...
                    z(
                      ...
                      zn(
                        ...
                        O => (
                          ...
                          P(
                            Be,
                            { key: O.path, item: O, "base-path": O.path },
                            null,
                            8,
                            ["item", "base-path"]
                          )
              ...
              f("div", Ko, [
                ...
                m(
                  ...
                  { trigger: "click" },
                  {
                    ...
                    default: _(() => [
                      f("span", Yo, [
                        f("img", { src: l(a), style: ln(l(r)) }, null, 12, Xo),
                        l(o) ? (d(), z("p", Go, nn(l(o)), 1)) : F("", !0)
                      ])
                    ]),
                    _: 1
                  }
                ...
                f(
                  "span",
                  {
                    class: "set-icon navbar-bg-hover",
                    title: "打开系统配置",
                    onClick: x[1] || (x[1] = (...O) => l(t) && l(t)(...O))
                  },
                  [m(A, { icon: l(Yi) }, null, 8, ["icon"])]
                )
              ])
            ])),
            [[q, l(bn)().wholeMenus.length === 0]]
          );
        }
      );
    }
  }),
  Jo = gn(Qo, [["__scopeId", "data-v-79cd98f7"]]),
  ns = { key: 0 },
  is = Z({
    __name: "index",
    setup(i) {
      const n = M(),
        ...
        { $storage: t } = ci(),
        s = Di({
          sidebar: I(() => Rn().sidebar),
          device: I(() => Rn().device),
          fixedHeader: I(() => h.fixedHeader),
          classes: I(() => ({
          ...
          hideTabs: I(() => (t == null ? void 0 : t.configure.hideTabs))
        });
      function o(y) {
        var j, p, b, x, D, A;
        (window.document.body.setAttribute("layout", y),
          (t.layout = {
            ...
            darkMode: (p = t.layout) == null ? void 0 : p.darkMode,
            sidebarStatus: (b = t.layout) == null ? void 0 : b.sidebarStatus,
            epThemeColor: (x = t.layout) == null ? void 0 : x.epThemeColor,
            themeColor: (D = t.layout) == null ? void 0 : D.themeColor,
            overallStyle: (A = t.layout) == null ? void 0 : A.overallStyle
          }));
      }
      function a(y, j) {
        (Rn().toggleDevice(y), Rn().toggleSideBar(j, "resize"));
      }
      let c = !0;
      (pi(n, y => {
        if (u) return;
        const j = y[0],
          [{ inlineSize: p, blockSize: b }] = j.borderBoxSize;
        (Rn().setViewportSize({ width: p, height: b }),
          p <= 760 ? o("vertical") : o(Rn().layout),
          p > 0 && p <= 760
            ? (a("mobile", !1), (c = !0))
            : p > 760 && p <= 990
              ? c && (a("desktop", !1), (c = !1))
              : p > 990 && !s.sidebar.isClickCollapse
                ? (a("desktop", !0), (c = !0))
                : (a("desktop", !1), (c = !1)));
      }),
        Pn(() => {
        ...
        render() {
          return ei(
            "div",
            {
              ...
              style: [
                s.hideTabs && g.value.includes("horizontal")
                  ? e.value
            ...
            [
              on(
                f(
                  ...
                  {
                    class: "app-mask",
                    onClick: j[0] || (j[0] = x => l(Rn)().toggleSideBar())
                  },
                  null,
                  512
                ),
                [
                  [
                    ...
                    s.device === "mobile" &&
                      s.sidebar.opened &&
                      l(g).includes("vertical")
                  ]
                ]
              ),
              on(m(Wo, null, null, 512), [
                [
                  En,
                  !l(h).hiddenSideBar &&
                    (l(g).includes("vertical") || l(g).includes("mix"))
                ]
              ]),
              f(
                "div",
                ...
                [
                  s.fixedHeader
                    ? (d(),
                      z("div", ns, [
                        m(l(r)),
                        m(be, { "fixed-header": s.fixedHeader }, null, 8, [
                          "fixed-header"
                        ])
                      ]))
                    : (d(),
  ...
  rs = gn(is, [["__scopeId", "data-v-9248ef5e"]]);
